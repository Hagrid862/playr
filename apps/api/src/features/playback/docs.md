...
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `query:get-state`                | Omit or `{}`                                                                                                             | [`GetPlaybackStateResponse`](../../../../../packages/contracts/src/playback/response/get-playback-state.response.ts) (`PlaybackState` **or `null`**) | **`null`** means no stored state yet (no Redis document). Matches nullable `GetPlaybackStateResponse` in contracts.                                                      |
