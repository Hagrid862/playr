...
export class GetLibraryPlaylistsResponseDto extends createZodDto(GetLibraryPlaylistsResponseSchema) {}
export class GetLibraryPlaylistDetailResponseDto extends createZodDto(
  GetLibraryPlaylistDetailResponseSchema,
) {}
export class CreateLibraryPlaylistResponseDto extends createZodDto(CreateLibraryPlaylistResponseSchema) {}
export class UpdateLibraryPlaylistResponseDto extends createZodDto(UpdateLibraryPlaylistResponseSchema) {}
export class DeleteLibraryPlaylistResponseDto extends createZodDto(DeleteLibraryPlaylistResponseSchema) {}
export class AddPlaylistTrackResponseDto extends createZodDto(AddPlaylistTrackResponseSchema) {}
export class RemovePlaylistTrackResponseDto extends createZodDto(RemovePlaylistTrackResponseSchema) {}
export class GetLibraryPlaylistPinsResponseDto extends createZodDto(GetLibraryPlaylistPinsResponseSchema) {}
...
export class ReorderPlaylistPinsResponseDto extends createZodDto(ReorderPlaylistPinsResponseSchema) {}
