...
import { libraryAlbumBuilder, libraryBuilder, userBuilder } from '@repo/testing/builders';
...
describe('GetLibraryAlbumsHandler', () => {
  ...
  it('should return library albums successfully', async () => {
    ...
    libraryAlbumRepository.findManyWithInclude.mockResolvedValue(mockItems as any);
