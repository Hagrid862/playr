...
function RouteComponent() {
  ...
  return (
    <div className="-mx-4 flex w-[calc(100%+2rem)] min-w-0 flex-col gap-6 px-4 pb-6 md:pb-8 lg:px-6 xl:px-8 lg:max-h-[calc(100dvh-15rem)] lg:min-h-0 lg:overflow-visible">
      <div className="mx-auto flex w-full min-w-0 max-w-[1920px] flex-col gap-6 lg:flex lg:min-h-0 lg:flex-1 lg:flex-col lg:overflow-visible">
