...
export type CreateLibraryRequestDto = z.infer<
  typeof CreateLibraryRequestSchema
>;

export const CreateLibraryResponseSchema =
  createApiResponseSchema(LibrarySchema);

export type CreateLibraryResponseDto = z.infer<
  typeof CreateLibraryResponseSchema
>;
